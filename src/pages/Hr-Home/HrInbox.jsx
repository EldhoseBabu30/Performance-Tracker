        ...
        <div>
          ...
          <ul className="divide-y divide-gray-200">
            {requests.map((request, index) => (
              <li key={index} className="py-4  border-gray-300 rounded-md border-2">
                <div className="flex items-center justify-between">
                  <div>
                    <span className="block text-gray-800 font-semibold">Team ID:</span> 
                    <span className="block text-gray-600">{request.teamId}</span>
                    <span className="block text-gray-800 font-semibold mt-2">Team Name:</span>
                    <span className="block text-gray-600">{request.teamName}</span>
                    <span className="block text-gray-800 font-semibold mt-2">Sent by Team Lead:</span>
